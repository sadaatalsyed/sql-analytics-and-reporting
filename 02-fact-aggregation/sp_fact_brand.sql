USE [RetailDW]
GO
/****** Object:  StoredProcedure [dbo].[SA_SP_OB_Brand]    Script Date: 7/14/2026 5:47:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER  PROCEDURE [dbo].[SA_SP_OB_Brand]
AS
BEGIN
 
DELETE FROM SA_OB_Brand WHERE [MONTH]=MONTH(GETDATE()-1) AND [YEAR]=Year(GETDATE()-1)

INSERT INTO SA_OB_Brand(
	DistributionID,
	DistributionType,
	ClassName,
	DistributionName,
...
SELECT sd.DistributionID,d.DistributionType,dc.ClassName,d.LegalName as  DistributionName,
ob.OrderBookerID,ob.Name as OrderBooker
,l1.Name as Level1Name,l2.Name Level2Name,l3.Name Level3Name,l4.Name Level4Name
,ch.Title ChannelName,sch.Title SubChannel,e.Title Element,se.Title SubElement
,t.Title Type,cat.Title Category,b.Title Brand
...
GROUP BY  sd.DistributionID,d.DistributionType,dc.ClassName,d.LegalName,ob.OrderBookerID,ob.Name
,l1.Name,l2.Name,l3.Name,l4.Name,ch.Title,sch.Title,e.Title,se.Title,t.Title,cat.Title,b.Title,
Se.SubElementID
