USE [RetailDW]
GO
/****** Object:  StoredProcedure [dbo].[SA_SP_OB_SKU]    Script Date: 7/14/2026 5:48:28 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER   PROCEDURE [dbo].[SA_SP_OB_SKU]
AS
BEGIN
 
DELETE FROM SA_OB_SKU WHERE [MONTH]=MONTH(GETDATE()-1) AND [YEAR]=Year(GETDATE()-1)
 

INSERT INTO SA_OB_SKU(
	DistributionID,
	DistributionType,
	ClassName,
	DistributionName,
...
,t.Title Type,cat.Title Category,b.Title as Brand,Seg.Title as Segment, v.VariantName as Variant
...
join Variant v on v.VariantID=p.VariantID
...
,t.Title,cat.Title,b.Title,seg.Title,V.VariantName
