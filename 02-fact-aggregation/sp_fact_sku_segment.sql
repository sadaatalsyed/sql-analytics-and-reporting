USE [RetailDW]
GO
/****** Object:  StoredProcedure [dbo].[SA_SP_SKU_Segment]    Script Date: 7/14/2026 5:49:00 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[SA_SP_SKU_Segment]
AS
BEGIN
 
DELETE FROM SA_SKU_Segment WHERE [MONTH]=MONTH(GETDATE()-1) AND [YEAR]=Year(GETDATE()-1)
 
INSERT INTO SA_SKU_Segment(
	DistributionID,
	DistributionType,
	ClassName,
	DistributionName,
...
SELECT 
sd.DistributionID,d.DistributionType,dc.ClassName,d.LegalName as  DistributionName
...
,t.Title Type,cat.Title Category,b.Title as Brand,Seg.Title as Segment
...
,SUM(sd.TotalValueWithTax-sd.FurtherTaxValue-sd.AdvanceTaxValue) as 'GrossAmountWithTax'
,SUM(sd.TotalValueWithTax-sd.TotalTax) as 'GrossAmountWithOutTax'
...
,getdate() AS 'AddOn',
Se.SubElementID,se.Attribute2 as SubElementAlias,SUM(sd.[VisibilityDiscount]) as 'VisibilityDiscount',
SUM(sd.[OffInvoiceDiscountB]) as 'OffInvoiceDiscountB'
...
join Segment seg on seg.SegmentID=p.SegmentID
...
GROUP BY  sd.DistributionID,d.DistributionType,dc.ClassName,d.LegalName
,l1.Name,l2.Name,l3.Name,l4.Name,ch.Title,sch.Title,e.Title,se.Title,t.Title,cat.Title,b.Title,seg.Title
,Se.SubElementID,se.Attribute2
